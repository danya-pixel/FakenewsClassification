...
def CB_objective(trial, task_type, train_pool, valid_pool, val):
    """Objective for optuna catboost tuning

    Args:
        trial: optuna trial (nothing needs to be sent)
        task_type: (str) "CPU" or "GPU"
        train_pool: Catboost train pool
        valid_pool: Catboost validation pool
        val: Validation dataset

    Returns:
        f1_score: F1 score of given trial
    """
    param = {
